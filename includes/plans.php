    ...
    <section class="padding-top-100 padding-bottom-50 ">
      <div class="container">
        ...
        <div class="choose-plan" id="residencial">
          ...
          <?php
              $a= $_SESSION['cidade'];
              $sql = $db->select("SELECT * FROM planos WHERE id_cidade=$a AND tipo_plano= 'RESIDENCIAL'");
        ...
        <?php
        $sql = $db->select("SELECT * FROM planos WHERE id_cidade= $a AND tipo_plano='EMPRESARIAL'");
        if($db->rows($sql)) {
        ?>
