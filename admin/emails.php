...
<div class="panel panel-primary">
	...
	<div class="panel-heading">
		<h4 class="panel-title"><h4>Cadastro Email's de Atendentes</h4></h4>
	</div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="texto" value="<?php if($x==1){ echo $texto;} ?>">
            </div>
        </div>
...
<ul class="list-group">
	...
	<?php
		$hoje=date("Y-m-d");
		$db = new DB();    
		$sel = $db->select("SELECT * FROM emails ORDER BY id DESC");
		if($db->rows($sel)){
			$x=1;	
