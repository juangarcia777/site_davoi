...
if(isset($_GET['action']) && $_GET['action']==1){
		...
		$arquivo = $Images->Upload('./img','img',000);

		if(!empty($arquivo)){
			$sel = $db->select("INSERT INTO banners (img, link) VALUES ('$arquivo','$link')");
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
           <div class="form-group">
                <label for="exampleInputEmail1">Banner <small>(1440X505)</small><span style="color: red;"> **</span>  </label>
...
<div class="row">
	...
	<?php
		$hoje=date("Y-m-d");
		$db = new DB();    
		$sel = $db->select("SELECT * FROM banners ORDER BY id DESC");
